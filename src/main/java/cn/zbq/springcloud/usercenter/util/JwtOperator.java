package cn.zbq.springcloud.usercenter.util;
...
public class JwtOperator {
    ...
    /*public static void main(String[] args) {
        ...
        // 会生成类似该字符串的内容: eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1NzY4NTQ2OTEsImV4cCI6MTU3ODA2NDI5MX0.54_AqoHtfrehglU0pFe8RZw8KqlCylokOuWO31_9TTo
        System.out.println(token);

        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1NzY4NTQ2OTEsImV4cCI6MTU3ODA2NDI5MX0.54_AqoHtfrehglU0pFe8RZw8KqlCylokOuWO31_9TTo";
